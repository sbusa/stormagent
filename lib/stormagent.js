...
(function() {
        ...
        this.db.on('load', (function(_this) {
          return function() {
            ...
            try {
              ...
              err = _error;
              _this.log("issue during processing the db file at " + filename, err);
            }
  ...
  StormAgent = (function(_super) {
    ...
    StormAgent.prototype["import"] = function(id) {
      var b, err, p, pkgconfig, plugfile, self, storm, _base, _fn, _i, _len, _ref, _ref1;
      ...
      try {
        this.state[b = (_base = require("" + id + "/package.json")).name != null ? _base.name : _base.name = id] = require("" + id + "/package.json").version;
          ...
          return async.waterfall([
            ...
            if (err || !storm) {
              ...
              try {
                ...
                err = _error;
                _this.log("Error writing the certs in to file" + err);
              }
