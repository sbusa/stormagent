...
(function() {
  ...
  StormAgent = (function(_super) {
    ...
    StormAgent.prototype.run = function(config, schema) {
      var err, logRequest, logfile, res, restify, _agent;
      _agent = this;
      if (config != null) {
        if (schema != null) {
      ...
      logRequest = (function(_this) {
        return function(request, response, next) {
          _this.log("REQUEST", request.toString());
          return next();
        };
      })(this);
      ...
      this.server.pre(logRequest);
      this.server.listen(this.config.port);
      this.include = (function(_this) {
        return function(plugin) {
          var that;
          _this.log("About to include the plugin ", plugin);
          that = _this;
          return plugin.include.call(that);
        };
      })(this);
