(function() {
  var EventEmitter, StormAgent, StormData, StormRegistry, agent, argv, async, config, storm, stormlog, util, uuid, _ref, _ref2, _ref3,
  ...
  stormlog = function(message, obj) {
    var out;
    if (message != null) out = "" + this.constructor.name + ": " + message;
    if (obj != null) out += "\n" + util.inspect(obj);
    if (out != null) return util.log(out);
  };
  ...
  StormData = (function(_super) {
    ...
    function StormData(id, data, schema) {
      ...
      if (data != null) this.validity = data.validity;
      this.saved = false;
    }
  ...
  StormRegistry = (function(_super) {
        ...
        this.db.on('load', function() {
          ...
          try {
            _this.db.forEach(function(key, val) {
              ...
              if (val != null) return _this.emit('load', key, val);
            });
          } catch (err) {
    ...
    StormRegistry.prototype.add = function(key, entry) {
      ...
      if (entry.id == null) entry.id = key;
      if (entry.saved == null) entry.saved = false;
      this.log("adding " + key + " into entries");
      if ((this.db != null) && !entry.saved) {
        data = entry;
        if (entry instanceof StormData) data = entry.data;
    ...
    StormRegistry.prototype.remove = function(key) {
      ...
      if (entry != null) this.emit('removed', entry);
    ...
    StormRegistry.prototype.expires = function(interval, validity) {
      var entry, key, _fn, _ref,
        _this = this;
      if (validity == null) validity = 60 * 60;
      _ref = this.entries;
      _fn = function(entry) {
        var _ref2;
        return (_ref2 = entry.validity) != null ? _ref2 : entry.validity = validity;
      };
      for (key in _ref) {
        entry = _ref[key];
        _fn(entry);
      ...
      return async.whilst(function() {
        ...
        var entry, key, _fn2, _ref2;
        _ref2 = _this.entries;
        _fn2 = function(key, entry) {
  ...
  StormAgent = (function(_super) {
    ...
    function StormAgent(config) {
      ...
      if (config != null) this.config = extend(this.config, config);
    ...
    StormAgent.prototype.run = function(config, schema) {
      ...
      if (config != null) {
        if (schema != null) {
          ...
          if (res.valid) this.config = extend(this.config, config);
        } else {
    ...
    StormAgent.prototype["import"] = function(id) {
      var p, pkgconfig, plugfile, self, storm, _fn, _i, _len, _ref, _ref2,
        _this = this;
      ...
      try {
        ...
        if (storm.functions != null) {
          ...
          if (!this.state.running) this.config = extend(this.config, pkgconfig);
        ...
        if (storm.plugins != null) {
          ...
          _fn = function(plugfile) {
            ...
            if (_this.state.running) _this.include(plugin);
      ...
      try {
        if (!((self != null) && self)) return require("" + id);
      } catch (err) {
    ...
    StormAgent.prototype.execute = function(command, callback) {
      var exec,
        _this = this;
      if (!command) return callback(new Error("no valid command for execution!"));
      ...
      srequest = function(method, url, storm, callback) {
        if ((method != null) && method instanceof Function && (url != null) && (storm != null)) {
          return method({
            ...
            if (callback != null) return callback(err, res, body);
      ...
      return async.until(function() {
        ...
        return async.waterfall([
          function(next) {
            ...
            if (storm.bolt.ca != null) return next(null, storm);
              ...
              try {
                ...
                switch (res.statusCode) {
                  case 200:
                    ...
                    if (bolt.ca == null) throw new Error("missing bolt.ca!");
        ...
        if (!(storm instanceof Error)) {
          if (callback != null) return callback(storm);
        }
      });
    };
  ...
  if (require.main === module) {
    ...
    config.logfile = (_ref2 = argv.l) != null ? _ref2 : "/var/log/stormagent.log";
    config.datadir = (_ref3 = argv.d) != null ? _ref3 : "/var/stormstack";
    storm = null;
