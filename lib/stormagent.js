...
(function() {
  var EventEmitter, StormAgent, StormData, StormRegistry, agent, argv, async, config, stormlog, util, uuid, _ref, _ref1, _ref2,
  ...
  StormAgent = (function(_super) {
    ...
    StormAgent.prototype.run = function(config, schema) {
      ...
      if (this.config.logfile != null) {
        ...
        try {
          proc.stdout.pipe(fs.createWriteStream(this.config.logfile, {
            flags: 'a'
          }));
        } catch (_error) {
          err = _error;
